...
// https://www.youtube.com/c/freelancerlifestyle444
...
window.onload = function () {
    ...
    // documentActions (делегирование события click)
    ...
    function loadProducts(data) {
		...
		<div div class = "item-product__content" >
			<h3 class="item-product__title">${productTitle}</h3>
			<div class="item-product__text">${productText}</div>
		</div>`;
            let productTemplatePrices = '';
            let productTemplatePricesStart = `<div class="item-product__prices">`;
            let productTemplatePricesCurrent = `<div class="item-product__price">${productPrice} грн.</div>`;
            let productTemplatePricesOld = `<div class="item-product__price item-product__price_old">${productOldPrice} грн.</div>`;
		...
		<div class = "item-product__actions action-product" >
			<div class = "action-product__body" >
				<a href = ""class = "action-product__button btn btn_white">В корзину</a>
